package com.bigbigrain.controller;
...
import com.bigbigrain.exception.CustomException;
import com.bigbigrain.pojo.Items;
import com.bigbigrain.service.ItemsService;
import com.bigbigrain.vo.QueryVo;
...
public class ItemsController {
	...
	public String testException(Model model) throws CustomException {
		//测试运行时异常
		//int i= 0/0;
		if(true) {
